...
if __name__=='__main__':
    ...
    fondos=pygame.image.load('tanque.png')
    ...
    for i in range (sp_alto): 
        ...
        for j in range(sp_ancho): 
            cuadro = fondos.subsurface(desp_x*j ,desp_y*i,330/sp_ancho,400/sp_alto)
            filas.append(cuadro)
        m.append(filas)
    ...
    sp_ancho2=4
    sp_alto2=4
    desp_x2= 275/sp_ancho2
    desp_y2= 160/sp_alto2
    m2=[]
    
    for i in range (sp_alto2): 
        filas2=[]
        for j in range(sp_ancho2): 
            cuadro2 = bal.subsurface(desp_x2*j ,desp_y2*i,275/sp_ancho2,160/sp_alto2)
    ...
    while not fin:
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
               ...
               if (event.button == 1) and (j1.fil == 2):
                   pos=[j1.rect.x + 30 , j1.rect.y + 20]
                   #pos=j1.rect.midtop
               ...
               if (event.button == 1) and (j1.fil == 0):
                   pos=[j1.rect.x + 30 , j1.rect.y + 80]
                   #pos=j1.rect.midtop
               ...
               if (event.button == 1) and (j1.fil == 1):
                   pos=[j1.rect.x + 30 , j1.rect.y + 20]
                   #pos=j1.rect.midtop
               ...
               if (event.button == 1) and (j1.fil == 3):
                   pos=[j1.rect.x + 30 , j1.rect.y - 20]
                   #pos=j1.rect.midtop
       ...
       #Cronometro
        ...
        img_texto=Fuente.render(texto, True, NEGRO)
